...
public class CinemaManager extends Observable implements Serializable
{
	...
	//public CinemaManager(ArrayList<Movie> movieList) {
		//this.movieList = movieList;
	//}
	...
	/*
	protected ArrayList<Theater> getTheaterListForCinema(int id)
	{
		return cinemaList.get(id-1).getTheaterList();
	}
	 */
	/*
	protected void setTheaterForCinema(int cinemaId,int theaterId,int rows,int cols)
	{
		 cinemaList.get(cinemaId-1).getTheaterList().get(theaterId-1).setNumOfRows(rows);
		 cinemaList.get(cinemaId-1).getTheaterList().get(theaterId-1).setNumOfCols(cols);
	}



	protected ArrayList<Integer> getTheaterListIdCinema(int cinemaId)
	{
		ArrayList<Integer>idList=new ArrayList<>();
		int num = cinemaList.get(cinemaId-1).getNumofTheaters();
	...
	//public void setMovieList(ArrayList<Movie> m) {
		//this.movieList=m;
//	}
	...
	protected <E> void readFile(ArrayList<E> list , String fileName )
	{
	...
	/*
	public <E> void writeToFile(ArrayList<E> list,String fileName)
	{	
		ObjectOutputStream outputStream=null;
		try	{
